...
class IntroductionScreen extends StatelessWidget {
  ...
  final data = [
    CardInsuranceData(
      ...
      image: const AssetImage("assets/pngs/logobg2.png"),
      backgroundColor: Color(0xFF05103A),
      titleColor: Colors.white,
      subtitleColor: Colors.white,
      background: LottieBuilder.asset("assets/lotties/anim7.json"),
    ),
    CardInsuranceData (
      title: "Begin an Insurance Check",
      subtitle: "Directly communicate with insurance company incase of accidents.",
    ...
    CardInsuranceData (
      title: "Get Reminders",
      subtitle: "Insurapp keeps you updated on policy status through notifications and reminders",
