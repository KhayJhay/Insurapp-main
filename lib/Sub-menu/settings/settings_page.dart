...
class _Settings_ScreenState extends State<Settings_Screen> {
  ...
  Widget buildChangePassword() => ListTile(
    ...
    title: Text("Change Password", style: TextStyle(fontSize: 14, fontFamily: 'Poppins-Medium'),),
    onTap: () {
      AwesomeDialog(
        context: context,
  ...
  Widget buildDelete() => ListTile(
    ...
    title: Text("Delete Account", style: TextStyle(fontSize: 14, fontFamily: 'Poppins-Medium'),),
    onTap: (){
      AwesomeDialog(
        context: context,
  ...
  Widget buildLanguage() => ListTile(
    ...
    title: Text("Change Language", style: TextStyle(fontSize: 14, fontFamily: 'Poppins-Medium'),),
    onTap: () {
      AwesomeDialog(
        context: context,
        dialogType: DialogType.WARNING,
  ...
  Widget buildSecurity() => ListTile(
    ...
    title: Text("Security", style: TextStyle(fontSize: 14, fontFamily: 'Poppins-Medium'),),
    onTap: (){
      AwesomeDialog(
        context: context,
  ...
  Widget buildPrivacy() => ListTile(
    ...
    title: Text("Privacy and Policies", style: TextStyle(fontSize: 14, fontFamily: 'Poppins-Medium'),),
    onTap: () {
      AwesomeDialog(
        context: context,
        dialogType: DialogType.WARNING,
