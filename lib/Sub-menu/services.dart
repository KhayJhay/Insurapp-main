...
import 'package:insurapp/Widgets/checker/myDigitalCard.dart';
import 'package:provider/provider.dart';

import '../providers/theme_provider.dart';
import 'help&support/tips_page.dart';
                ...
                Card(
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        "With the virtual assistant's 24/7 availability, you can be assured of getting the needed assistance anytime.  ",
                        style: TextStyle(
                          fontSize: 12,
                          fontFamily: "Poppins-Light",
                        ),
                ...
                Card(
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        "Apart from insurance services, our app offers you all the road assistance you need to keep going on a trip.  ",
                        style: TextStyle(
                          fontSize: 12,
                          fontFamily: "Poppins-Light",
                        ),
